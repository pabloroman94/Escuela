...
namespace CoreEscuela.App
{
    public sealed class EscuelaEngine
    {
        ...
        {
            Escuela = new Escuela("UBA Academy", 2012, TiposEscuela.Primaria,
            ciudad: "Bogotá", pais: "Argentina"
            );
        ...
        private List<Alumno> GenerarAlumnosAlAzar(int cantidad)
        {
            ...
            string[] nombre2 = { "Julio", "Anabel", "Rick", "Murty", "Silvana", "Diomedes", "Nicomedes", "Teodoro" };
